...
function install_lookingglass() {
  ...
  make
  sudo make install
  # Copy Looking Glass Client build log
  cp ~/.cache/libvf.io/compile/LookingGlass/client/build/CMakeFiles/CMakeOutput.log ~/
